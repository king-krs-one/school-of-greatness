"""
Django settings for school_of_greatness project.
...
ROOT_URLCONF = 'school_of_greatness.urls'
...
WSGI_APPLICATION = 'school_of_greatness.wsgi.application'
...
AUTH_COOKIE_PATH = '/'
AUTH_COOKIE_SAMESITE = False if DEVELOPMENT_MODE else 'None'
